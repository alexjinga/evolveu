...
class InfoForm(FlaskForm):
    ...
    mood = RadioField('Please choose your mood:', choices=[('mood_1','Happy'),('mood_2', 'Excited')])
    # mood = RadioField(
    ...
    #     ]
    # )
    food_choices = SelectField (u'Pick your favourite food:', choices=[('chi','Chicken'), ('bf','Beef'), ('fish','Fish')])
    # food_choices = SelectField (
    #     u'Pick your favourite food:', 
    #     choices=[
    #         ('chi','Chicken'), 
    #         ('bf','Beef'), 
    #         ('fish','Fish')
